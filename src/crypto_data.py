...
ASSETS = {"btc": "BTCUSDT", "eth": "ETHUSDT", "sol": "SOLUSDT", "gold": "PAXGUSDT"}
# "gold" = PAXG (PAX Gold), Binance's gold-backed token — tracks spot gold 1:1 per troy oz,
# same kline format as the crypto pairs. Lists from 2020-08; macro / risk-off context asset.
